    ...
    >
      <View style={styles.financialHeader}>
        <View style={styles.financialIconBox}>
          <Feather name="file" size={rs(20)} color="#38BDF8" />
        </View>
         <View style={styles.financialTitleCol}>
            <Typography style={styles.financialTitle}>Pick & Choose{"\n"}Quote 20251126</Typography>
         </View>
      ...
      <View style={styles.financialRow}>
        ...
        <Typography style={styles.financialValue}>100% of order</Typography>
      </View>
      <View style={styles.financialRow}>

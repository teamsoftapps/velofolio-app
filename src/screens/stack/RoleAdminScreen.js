...
const PERMISSION_GROUPS = [
  {
    ...
    items: [
      ...
      { id: 'edit_clients', label: 'Edit Clients', initial: true },
      { id: 'delete_clients', label: 'Delete Clients', initial: true },
    ],
  },
  {
    title: 'Jobs',
    items: [
      ...
      { id: 'close_jobs', label: 'Close Jobs', initial: true },
    ],
  },
  {
    title: 'Payments',
  ...
  {
    title: 'System Alerts', // Actually screenshot says "System Alerts" but items are "Manage Roles", "Edit Company Info"
    items: [
...
const RoleAdminScreen = ({ navigation }) => {
    ...
    <ScreenWrapper backgroundColor="#FAFAFA" disablePaddingTop={true}>
      <View style={[styles.topWhiteContainer, { paddingTop: insets.top }]}>
        <View style={styles.header}>
          ...
          <Typography style={styles.headerTitle}>Admin</Typography>
        </View>
      </View>

...
const SECTIONS = [
  {
    ...
    items: [
      { icon: 'mail', label: 'Email Settings', route: 'EmailSettings' },
      { icon: 'at-sign', label: 'Email Sender Settings', route: 'EmailSenderSettings' },
      { icon: 'bell', label: 'Notification Preferences', route: 'NotificationPreferences' },
      { icon: 'inbox', label: 'Email Templates', route: 'EmailTemplates' },
    ],
  },
];

const EmailNotificationsScreen = ({ navigation }) => {
    ...
    <ScreenWrapper backgroundColor="#FAFAFA" disablePaddingTop={true}>
      <View style={[styles.topWhiteContainer, { paddingTop: insets.top }]}>
        <View style={styles.header}>
          ...
          <Typography style={styles.headerTitle}>Email & Notifications</Typography>
        </View>
      </View>

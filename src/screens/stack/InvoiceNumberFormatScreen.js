...
const FORMATS = [
  { id: '1', label: '2025-INV-001' },
  { id: '2', label: 'INV-001-2025' },
  { id: '3', label: '001-INV-2025' },
  { id: '4', label: '001-2025-INV' },
];

const InvoiceNumberFormatScreen = ({ navigation }) => {
    ...
    <ScreenWrapper backgroundColor="#FAFAFA" disablePaddingTop={true}>
      <View style={[styles.topWhiteContainer, { paddingTop: insets.top }]}>
        <View style={styles.header}>
          ...
          <Typography style={styles.headerTitle}>Invoice Number Format</Typography>
        </View>
      </View>
...
export default InvoiceNumberFormatScreen;

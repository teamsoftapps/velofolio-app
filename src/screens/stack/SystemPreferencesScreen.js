...
const SECTIONS = [
  {
    title: 'System',
    items: [
      { icon: 'settings', label: 'General Settings', route: 'GeneralSettings' },
      { icon: 'briefcase', label: 'Job & Payment Defaults', route: 'JobPaymentDefaults' },
      { icon: 'git-commit', label: 'Workflow Settings', route: 'WorkflowSettings' },
      { icon: 'paperclip', label: 'Files & Automation', route: 'FilesAutomation' },
    ],
  },
];

const SystemPreferencesScreen = ({ navigation }) => {
    ...
    <ScreenWrapper backgroundColor="#FAFAFA" disablePaddingTop={true}>
      <View style={[styles.topWhiteContainer, { paddingTop: insets.top }]}>
        <View style={styles.header}>
          ...
          <Typography style={styles.headerTitle}>System Preferences</Typography>
        </View>
      </View>
...
export default SystemPreferencesScreen;

...
const PERMISSION_GROUPS = [
  {
    ...
    items: [
      ...
      { id: 'add_clients', label: 'Add Clients', initial: false },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'assign_jobs', label: 'Assign Jobs', initial: false },
  ...
  },
  {
    title: 'Payments',
    items: [
      { id: 'view_payments', label: 'View Payments', initial: false },
  ...
  },
  {
    title: 'System Alerts',
    items: [
      { id: 'manage_roles', label: 'Manage Roles', initial: false },
      { id: 'edit_company', label: 'Edit Company Info', initial: false },
    ],
  },
];

const RoleEditorScreen = ({ navigation }) => {
    ...
    <ScreenWrapper backgroundColor="#FAFAFA" disablePaddingTop={true}>
      <View style={[styles.topWhiteContainer, { paddingTop: insets.top }]}>
        <View style={styles.header}>
          ...
          <Typography style={styles.headerTitle}>Editor</Typography>
        </View>
      </View>

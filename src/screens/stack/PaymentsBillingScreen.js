...
const SECTIONS = [
  {
    ...
    items: [
      { icon: 'zap', label: 'Current Plan', route: 'CurrentPlan' },
      { icon: 'file-text', label: 'Billing History', route: 'BillingHistory' },
      { icon: 'credit-card', label: 'Payment Methods', route: 'PaymentMethods' },
    ],
  },
];

const PaymentsBillingScreen = ({ navigation }) => {
    ...
    <ScreenWrapper backgroundColor="#FAFAFA" disablePaddingTop={true}>
      <View style={[styles.topWhiteContainer, { paddingTop: insets.top }]}>
        <View style={styles.header}>
          ...
          <Typography style={styles.headerTitle}>Payments & Billing</Typography>
        </View>
      </View>
...
export default PaymentsBillingScreen;
